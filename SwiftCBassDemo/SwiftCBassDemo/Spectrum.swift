...
//  SwissBassDemo
//
//  This view renders a visualization of the simple one-dimensional spectrum (using a mean-square amplitude scale)
//  of the music.
...
struct Spectrum: View {
    ...
    @Environment(AudioManager.self) private var audioManager: AudioManager
